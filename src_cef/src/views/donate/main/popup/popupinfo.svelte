<div class="newdonate__info">
    <div class="newdonate__info-block">
        ...
        <div class="newdonate__info-info">
            ...
            <b>RedBucks</b> - это донат-валюта проекта, получить которую можно путём пожертвования, используя внутриигровой интерфейс (кнопка "Купить" справа) или <b>личный кабинет</b> (https://discord.gg/gejDFbARdE). <br> <br> Так же <b>RB</b> можно получить просто так, каждый день, просто проводя время в игре! <br> Если коротко: в месяц можно получить до <b>1200 RedBucks абсолютно бесплатно</b>.  Подробнее об этом можно узнать на нашей <b>Википедии</b>
            </div>
        </div>
    </div>
