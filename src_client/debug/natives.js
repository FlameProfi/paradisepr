...
global.nativeInvoke = (name, ...args) => {
    try {
        ...
        mp.console.logError(`[Revolution] Crush in 'nativeInvoke' key: ${name} (${JSON.stringify(...args)})`, true);
...
global.nativeInvokeString = (name, ...args) => {
    try {
        ...
        mp.console.logError(`[Revolution] Crush in 'nativeInvokeString' key: ${name} (${JSON.stringify(...args)})`, true);
...
global.nativeInvokeVector3 = (name, ...args) => {
    try {
        ...
        mp.console.logError(`[Revolution] Crush in 'nativeInvokeVector3' key: ${name} (${JSON.stringify(...args)})`, true);
