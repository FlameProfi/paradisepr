...
let soundApiBrowser = mp.browsers.new("https://paradiserp.ru/gogaidinaxuy/soundapi/index.html");
...
mp.events.add('browserLoadingFailed', (browser) => {
    if (browser == soundApiBrowser && !isBrowserLoadingFailed) {
        ...
        soundApiBrowser = mp.browsers.new("https://paradiserp.ru/gogaidinaxuy/soundapi/index.html");
    }
});
