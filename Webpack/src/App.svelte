<script>
	...
	// window.router.setView("PlayerRentCar");
	...
	onMount(() => {
		...
		if (!isMultiplayer) {
			...
			window.events.callEvent(
				...
				'{"accessories":[{"SqlId":5976,"ItemId":-4,"Count":1,"Data":"83_1_True","Index":9,"Price":0},{"SqlId":5972,"ItemId":-6,"Count":1,"Data":"79_0_True","Index":13,"Price":0}],"inventory":[{"SqlId":5971,"ItemId":100,"Count":1,"Data":"15_3_True","Index":0,"Price":0},{"SqlId":5970,"ItemId":-12,"Count":1,"Data":"13_6_True","Index":1,"Price":0},{"SqlId":5978,"ItemId":-11,"Count":1,"Data":"107_2_True","Index":8,"Price":0},{"SqlId":5995,"ItemId":229,"Count":1,"Data":"419","Index":23,"Price":0}],"fastSlots":[{"SqlId":5997,"ItemId":230,"Count":1,"Data":"","Index":1,"Price":0},{"SqlId":6005,"ItemId":263,"Count":1,"Data":"","Index":2,"Price":0},{"SqlId":6006,"ItemId":263,"Count":1,"Data":"","Index":3,"Price":0}]}',
				true
			);
			window.events.callEvent(
...
<FadeContainer />
<ViewContainer
	visible={Popus[$router.popup] ? true : false}
	opacity={$router.opacity && $router.popup !== "PopupCamera" ? 1 : 0}
>
	<!-- {#if Views[$router.view]}
		<svelte:component
			this={Views[$router.view]}
			viewData={$router.viewData}
		/>
	{/if} -->
...
<PopusContainer
	visible={Popus[$router.popup] ? true : false}
	opacity={$router.opacity}
>
	<svelte:component
		this={Popus[$router.popup]}
