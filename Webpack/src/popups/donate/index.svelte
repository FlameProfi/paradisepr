<script>
	...
	window.notificationAdd(4, 9, `Вы начали процесс покупки Battle Pass. Совершите донат через дискорд (https://discord.gg/gejDFbARdE) в размере 1999 руб, и премиум-доступ автоматически станет доступен.`, 25000);
	executeClient ("client.donatepack.donate", popupData.id);
	executeClient ("client.donatepack.close");

	/*axios.post('https://discord.gg/gejDFbARdE', qs.stringify({
	name: $accountLogin,
