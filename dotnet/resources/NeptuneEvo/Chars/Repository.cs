    ...
    class Repository : Script
    {
        ...
        public static List<RouletteCaseData> RouletteCasesData = new List<RouletteCaseData> { 
            ...
            */ 
            ...
            new RouletteCaseData(ItemId.Case11, "Легендарный кейс", 5555, new List<RouletteItemData>(), "keys_11", "Все или ничего! Хочешь рискнуть и стать обладателем легендарной кофты RevoRP? Тогда крути кейс!"), 
            ...
            new RouletteCaseData(ItemId.Case16, "Revolution кейс [М]", 5000, new List<RouletteItemData>(), "keys_16", "Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. Насколько быстро ты сможешь собрать свой сет?"),   
            ...
            new RouletteCaseData(ItemId.Case19, "Revolution кейс [Ж]", 5000, new List<RouletteItemData>(), "keys_19", "Эксклюзивный кейс из Battle Pass, в нем находится несколько комплектов одежды с одинаковым шансов выпадения. Насколько быстро ты сможешь собрать свой сет?"),  
        ...
        public static void ChangeAutoNumberInit()
        {
            ...
            PedSystem.Repository.CreateQuest("s_m_m_fiboffice_02", new Vector3(-550.27765, -189.844, 38.21586), 158.65244f, title: "~y~NPC~w~ Эдвард Дэниелс\nСмена номеров", colShapeEnums: ColShapeEnums.ChangeAutoNumber);
 ...
 */
        ...
        public static IReadOnlyDictionary<ItemId, ItemsInfo> ItemsInfo = new Dictionary<ItemId, ItemsInfo>()
        {
            ...
            { ItemId.Case11, new ItemsInfo(RouletteCasesData[11].Name, "Все или ничего! Хочешь рискнуть и стать обладателем легендарной кофты RevoRP? Тогда крути кейс!", "inv-item-case11", "Особое", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
