...
namespace NeptuneEvo.MoneySystem
{
    class Casino : Script
    {
        ...
        public static Vector3[] casinoChecks = new Vector3[7]
                {
            new Vector3(923.7674, 46.93772, 81.10636), // Маркер входа с улицы в казино
            ...
            new Vector3(964.5882, 58.714985, 112.55302), // Маркер выхода с крыши казино
            new Vector3(1085.6758, 214.83003, -49.200443), // Маркер входа на крышу казино
            new Vector3(967.5404, 63.767876, 112.55302), // Маркер входа в penthouse с крыши казино
