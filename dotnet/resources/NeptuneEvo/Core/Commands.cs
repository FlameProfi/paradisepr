            ...
            try
            {
                ...
                switch (cmd)
                {
                    ...
                    case "m":
                        ...
                        if ((!Configs.IsFractionPolic(fracId) && fracId != (int)Fractions.Models.Fractions.ARMY &&fracId != (int)Fractions.Models.Fractions.PRISON) || !NAPI.Player.IsPlayerInAnyVehicle(sender)) return;
                        var vehicle = (ExtVehicle) sender.Vehicle;
                        var vehicleLocalData = vehicle.GetVehicleLocalData();
                        if (vehicleLocalData != null)
                        {
                            if (vehicleLocalData.Access != VehicleAccess.Fraction) return;
                            if (!Configs.IsFractionPolic(vehicleLocalData.Fraction) && vehicleLocalData.Fraction != (int)Fractions.Models.Fractions.ARMY && vehicleLocalData.Fraction != (int)Fractions.Models.Fractions.PRISON) return;
