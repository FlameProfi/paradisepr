...
namespace NeptuneEvo.Core
{
    class Economy : Script
    {
        ...
        public static void ResetToDefault()
        {
            ...
            Main.DrugsPrice = 600;
            Main.BuswaysPayments = new int[6] { 800, 1000, 800, 1000, 1000, 1600 };
            Main.CollectorPayment = 900;
            Main.ElectricianPayment = 500;
            Main.PostalPayment = 700;
            Main.LawnmowerPayment = 200;
