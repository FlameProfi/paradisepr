                ...
                */
                ...
                if (Main.ServerSettings.IsDeleteProp)
                {
                    ...
                    NAPI.World.DeleteWorldProp(NAPI.Util.GetHashKey("v_ilev_gasdoor"),
                        new Vector3(1699.661, 4930.278, 42.21359), 30f);
                    ////////////////
                    NAPI.World.DeleteWorldProp(NAPI.Util.GetHashKey("v_ilev_ct_door01"),
                        new Vector3(-2345.2769, 3225.4983, 29.224829), 3f);
                    NAPI.World.DeleteWorldProp(NAPI.Util.GetHashKey("v_ilev_ct_door02"),
                        new Vector3(-2345.2769, 3225.4983, 29.224829), 3f);
                    NAPI.World.DeleteWorldProp(NAPI.Util.GetHashKey("v_ilev_ct_door03"),
                        new Vector3(-2345.2769, 3225.4983, 29.224829), 3f);
                    NAPI.World.DeleteWorldProp(NAPI.Util.GetHashKey("v_ilev_ct_doorl"),
                        new Vector3(-2345.2769, 3225.4983, 29.224829), 3f);
                    NAPI.World.DeleteWorldProp(NAPI.Util.GetHashKey("v_ilev_ct_doorr"),
                        new Vector3(-2345.2769, 3225.4983, 29.224829), 3f);
                }
