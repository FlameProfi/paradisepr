        ...
        public static void playerPressCuffBut(ExtPlayer player)
        {
            try
            {
                ...
                if (!cdata.Cuffed)
                {
                    ...
                    if (fracId == (int) Models.Fractions.CITY || Configs.IsFractionPolic(fracId) || fracId == (int) Models.Fractions.ARMY || fracId == (int) Models.Fractions.PRISON) cdata.CuffedByCop = true;
