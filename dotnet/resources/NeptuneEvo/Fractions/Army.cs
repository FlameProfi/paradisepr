    ...
    class Army : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[10], 1, 2, 0, ColShapeEnums.FractionArmy, 9);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"), new Vector3(ArmyCheckpoints[10].X, ArmyCheckpoints[10].Y, ArmyCheckpoints[10].Z), 5F, 0.3F, 0, new Color(255, 255, 255), dimension: 0);
                ...
                NAPI.Marker.CreateMarker(21, ArmyCheckpoints[10], new Vector3(), new Vector3(), 1f, new Color(255, 255, 255, 220), dimension:0);
        ...
        public static Vector3[] ArmyCheckpoints = new Vector3[13]
        {
            ...
            new Vector3(-2417.5251, 3329.46, 32.82851), // army docks mats     2
            ...
            new Vector3(-2340.4978, 3264.1155, 32.818863), // Починка наземного транспорта 6
            new Vector3(-2162.036, 3216.9812, 32.78042), // Починка воздушного транспорта 7
            new Vector3(-2348.3184, 3245.8267, 32.829857), // Общая тревога кнопка 8
            new Vector3(-2344.5896, 3226.6045, 29.22482), // Вход из мира в инту 9
            new Vector3(-2345.4094, 3225.2507, 29.22482), // Выход из инты в мир 10
            new Vector3(-2356.8071, 3261.7673, 34.997856), // Вход из мира в инту 11
