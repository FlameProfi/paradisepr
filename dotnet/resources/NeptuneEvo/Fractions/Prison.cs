...
namespace NeptuneEvo.Fractions
{
    class Prison : Script
    {
        ...
        private static Vector3 ArrestPosition = new Vector3(1784.5087, 2594.3054, 45.798428);
        public static Vector3 GunsPosition = new Vector3(1783.8416, 2543.3865, 45.797993);
        public static Vector3 CloakroomPosition = new Vector3(1777.8944, 2548.7966, 45.797993);
        private static Vector3 CloakroomSpecialPosition = new Vector3(-463.5043, -999.32587, -230.68949);
        public static Vector3 PrisonPosition = new Vector3(1777.5653, 2581.8826, 45.798443);
        ...
        private static Vector3 VehicleBoostPosition = new Vector3(1408.2571, -183.5331, -409.280865);//463.32733, -1019.0836, 28.10166
