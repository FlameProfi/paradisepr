...
namespace NeptuneEvo.Fractions
{
    class Manager : Script
    {
        ...
        public static void onResourceStart()
        {
            try
            {
                ...
                Main.CreateBlip(new Main.BlipData(590, "News", LsNewsSystem.LSNewsCoords[0], 4, true, 1.3f));
        ...
        public static IReadOnlyDictionary<int, FractionsType> FractionTypes = new Dictionary<int, FractionsType>() // 0 - mafia, 1 gangs, 2 - gov, 3 -  nongov, 4 - bikers
        {
            ...
            {(int) Models.Fractions.PRISON, FractionsType.Gov}, // Prison
        ...
        public static IReadOnlyDictionary<int, string> FractionNames = new Dictionary<int, string>()
        {
            ...
            {(int) Models.Fractions.PRISON, "S.A.S.P" },
    ...
    class MatsWar : Script
    {
        ...
        private static Vector3 warPosition = new Vector3(-2333.4243, 3256.9868, 32.81612);
        ...
        public static void startWar()
        {
            try
            {
                ...
                Manager.sendFractionMessage((int) Models.Fractions.PRISON, LangFunc.GetText(LangType.Ru, DataName.WzmShipGoing));
        ...
        public static void endWar()
        {
            try
            {
                ...
                Manager.sendFractionMessage((int) Models.Fractions.PRISON, LangFunc.GetText(LangType.Ru, DataName.WzmShipGone));
        ...
        public static void OnWar(ExtPlayer player)
        {
            try
            {
                ...
                if (sessionData == null) return;
                var fracId = player.GetFractionId();
                if (!((fracId >= (int)Models.Fractions.FAMILY && fracId <= (int)Models.Fractions.BLOOD) || (fracId >= (int)Models.Fractions.LCN && fracId <= (int)Models.Fractions.ARMENIAN) || (fracId >= (int)Models.Fractions.THELOST && fracId <= (int)Models.Fractions.PRISON)))
                {
