...
namespace NeptuneEvo.Fractions.LSNews
{
    class LsNewsSystem : Script
    {
        ...
        {
            new Vector3(-1064.2603, -237.59189, 44.02118), // Переодевалка
            new Vector3(-1083.2177, -245.80663, 37.763195),
        };
        ...
        public void OnResourceStartHandler()
        {
            try
            {
                ...
                PedSystem.Repository.CreateQuest("ig_molly", new Vector3(-1083.2177, -245.80663, 37.763195), -157.9755f, title: "~y~NPC~w~ Дженнифер", colShapeEnums: ColShapeEnums.FracLSNews);
                PedSystem.Repository.CreateQuest("ig_englishdave_02", new Vector3(-1074.907, -248.17271, 37.763233), 138.08324f, title: "~y~NPC~w~ Журналист Шаманчик\nВызвать сотрудника", colShapeEnums: ColShapeEnums.CallNewsMember);
            }
            catch (Exception e)
            {
