...
{ 
    ...
    { 
        ...
        public static Vector3 CloakroomPosition = new Vector3(-560.6431, -192.5937, 38f); 
        public static Vector3 SecondCloakroomPosition = new Vector3(-558.9366f, -195.66084f, 38f); 
        private static Vector3 StockPosition = new Vector3(-568.53937, -194.7967, 38.21581f); 
        public static Vector3 GiveGunPosition = new Vector3(-563.2642, -188.92635, 38.215824f); 
        public static Vector3 SecondGiveGunPosition = new Vector3(2487.9102f, -376.6428f, 82.69f); 
        public static Vector3 GpsPosition = new Vector3(-550.35095, -197.04575, 38.21f); 
        private static Vector3 CallingEmployeesPosition = new Vector3(-550.2553, -189.65509, 80.215836f);

        private static Vector3 JobPosition = new Vector3(-554.728, -192.1984, 38.21584);
